...
public class SprayParticle extends TextureSheetParticle {
    ...
    public void render(VertexConsumer buffer, Camera camera, float tickDelta) {
        ...
        float cx = (float) (Mth.lerp(tickDelta, this.xo, this.x) - cameraPos.x());
        float cy = (float) (Mth.lerp(tickDelta, this.yo, this.y) - cameraPos.y());
        float cz = (float) (Mth.lerp(tickDelta, this.zo, this.z) - cameraPos.z());
