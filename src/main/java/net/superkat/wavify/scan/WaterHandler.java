 ...
 * <p>
 * Join world -> Nearby chunks are added via loadChunk(), then once all nearby chunks are loaded via {@link WavifyWaveHandler#nearbyChunksLoaded(ClientPlayerEntity)}, the scheduleChunkScans method is called.<br><br>
 * <p>
