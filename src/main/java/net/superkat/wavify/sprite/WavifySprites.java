...
public class WavifySprites {
    ...
    public static final ResourceLocation MOVING_TEXTURE_ID = new ResourceLocation(MOD_ID, "moving");
    public static final ResourceLocation MOVING_WHITE_TEXTURE_ID = new ResourceLocation(MOD_ID, "moving_white");

    public static final ResourceLocation TOP_WASHING_ID = new ResourceLocation(MOD_ID, "washing_top_colorable");
    public static final ResourceLocation TOP_WASHING_WHITE_ID = new ResourceLocation(MOD_ID, "washing_top_white");
    public static final ResourceLocation BOTTOM_WASHING_ID = new ResourceLocation(MOD_ID, "washing_bottom_colorable");
    public static final ResourceLocation BOTTOM_WASHING_WHITE_ID = new ResourceLocation(MOD_ID, "washing_bottom_white");

    public static final ResourceLocation WASHING_TEXTURE_ID = new ResourceLocation(MOD_ID, "washing");
    public static final ResourceLocation WASHING_WHITE_TEXTURE_ID = new ResourceLocation(MOD_ID, "washing_white");

    public static final ResourceLocation WET_OVERLAY_TEXTURE_ID = new ResourceLocation(MOD_ID, "wet_overlay");
