...
public class WaveRenderer {
    ...
    private void renderWave(PoseStack matrices, BufferBuilder buffer, Camera camera, Wave wave, float delta, Sheets sheets, float bodyBase, float foamBase) {
    ...
    private void renderWashingUnderside(PoseStack matrices, BufferBuilder buffer, Wave wave, Sheets sheets,
